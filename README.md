<div align="center">
  ...
  <div style="padding: 10px;">
    ...
    <p style="margin-bottom: 0; line-height: 1.5;">
      ...
      por enquanto essas são minhas ferramentas de trabalho: 
    </p>
  </div>
</div>
...
| Design, UI/UX | Frontend | Ferramentas |
| :---: | :---: | :---: |
...
<table border="0">
<tr>
<td valign="top" width="160" style="height: 1px; max-width: 160px; min-width: 160px;">
  <img src="https://github.com/raquelalve/raquelalve/blob/main/assets/downloadkamaji%20(1).gif?raw=true" style="display: block; width: 160px; height: 100%; object-fit: cover; max-height: 100%;" alt="Animação do Projeto" />
</td>
